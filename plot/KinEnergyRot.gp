...
# Plotting the data
plot "../data/BORIS.dat" using 1:5 index 0 w l lw 1.0 lc rgb "blue" title "Boris dt = 1.0"
...
replot "../data/RK4.dat" using 1:5 index 4 w l lw 1.0 lc rgb "purple" title "RK4 dt = T/1000"